    ...
    */
    <div className="hidden sm:flex flex-col h-screen w-20 md:w-64 bg-[#1e2128] text-white p-4 md:p-6 transition-all duration-300">
      ...
      <nav className="flex flex-col gap-4">
        ...
        <button onClick={()=>navigate("/uploadreceipt")} className="flex items-center justify-center md:justify-start gap-4 text-gray-400 p-3 hover:bg-[#252830] rounded-xl transition-colors">
