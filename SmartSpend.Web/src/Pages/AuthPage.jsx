...
function AuthPage() {
  // 1. Setup state to toggle between Login and Register
  const [isActive, setIsActive] = useState(false);

  // Simple functions for handling clicks
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-[#e2e2e2] to-[#c9d6ff] font-['Poppins'] p-5">
      ...
      {/* Main Container */}
      <div className="relative w-[850px] h-[550px] bg-white rounded-[30px] shadow-[0_0_30px_rgba(0,0,0,0.2)] overflow-hidden transition-all duration-700">
        
        {/* Login Form Section */}
        <div className={`absolute right-0 w-1/2 h-full bg-white flex items-center text-center p-10 z-[1] transition-all duration-[600ms] delay-[1200ms] 
          ${isActive ? "-translate-x-full opacity-0 invisible" : "translate-x-0 opacity-100 visible"}`}>
          <form className="w-full">
            <h1 className="text-4xl font-bold mb-4">Login</h1>
            
            <div className="relative my-8">
              <input type="text" placeholder="Username" className="w-full py-3 px-5 pr-12 bg-[#eee] rounded-lg outline-none font-medium" required />
        ...
        <div className={`absolute right-0 w-1/2 h-full bg-white flex items-center text-center p-10 z-[1] transition-all duration-[600ms] delay-[1200ms] 
          ...
          <form className="w-full">
            ...
            <div className="relative my-8">
              <input type="email" placeholder="Email" className="w-full py-3 px-5 pr-12 bg-[#eee] rounded-lg outline-none font-medium" required />
            ...
            {/* <p className="text-[14.5px] my-4 text-gray-600">or register with social platforms</p>
        ...
        <div className="absolute w-full h-full pointer-events-none">
          ...
          <div className={`absolute left-0 w-1/2 h-full flex flex-col justify-center items-center text-white z-[2] transition-all duration-[600ms] pointer-events-auto
            ...
            <button onClick={handleRegisterClick} className="w-40 h-[46px] border-2 border-white rounded-lg font-semibold bg-transparent hover:bg-white hover:text-[#7494ec] transition-all">
                Register
            </button>
          </div>
          ...
          <div className={`absolute right-0 w-1/2 h-full flex flex-col justify-center items-center text-white z-[2] transition-all duration-[600ms] pointer-events-auto
            ...
            <button onClick={handleLoginClick} className="w-40 h-[46px] border-2 border-white rounded-lg font-semibold bg-transparent hover:bg-white hover:text-[#7494ec] transition-all">
                Login
            </button>
          </div>
        </div>
...
// Simple Helper function for icons
function SocialIcon(props) {
  return (
    <a href="#" className="inline-flex p-2 border-2 border-gray-300 rounded-lg text-2xl text-gray-800 transition-colors hover:bg-gray-100">
